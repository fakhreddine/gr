    ...
    <div class="col-md-10 col-md-offset-1">
        <div class="panel panel-primary">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-md-6">
					<div class="form-group">
                        <input type="number" name="first_name" id="first_name" class="form-control input-lg" placeholder="Age" tabindex="1">
					</div>
				</div>
				<div class="col-xs-6 col-sm-6 col-md-6">
					<div class="form-group">
	<select class="form-control input-lg" ><option value="Mme">Madame</option><option value="Mr">Monsieur</option></select>
