...
<div class="row booking_summary">
	<div class="span12">	
		<c:url var="comfirm" value="/reservation/comfirm-step-two" ></c:url>
		<form:form action="${comfirm}" commandName="reservation">
		<div class="row">
			<div class="span9">
					...
					<fieldset>
						...
						<div class="row">
							<div class="span9">
								...
								<input  class="btn btn-primary btn-large book-now pull-right" value="continue"/>
								<br />
								<br />
							</div>
						</div>
