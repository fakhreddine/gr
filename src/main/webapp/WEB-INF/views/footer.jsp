	...
	<div class="span4">
		<h4>Sponsors<span class="line"></span></h4>
		    <ul class="thumbnails">
				<li class="span2">
					<div class="thumbnail">
						<img src="<%=request.getContextPath()%>/resources/css/images/airlines/virgin4.gif" alt="">
					</div>
				</li>				
				<li class="span2">
					<div class="thumbnail">
				...
				<li class="span2">
					<div class="thumbnail">
						<img src="<%=request.getContextPath()%>/resources/css/images/airlines/delta3.gif" alt="">
					</div>
				</li>										
				<li class="span2">
					<div class="thumbnail">
						<img src="<%=request.getContextPath()%>/resources/css/images/airlines/ac_white.jpg" alt="">
					</div>
				</li>
