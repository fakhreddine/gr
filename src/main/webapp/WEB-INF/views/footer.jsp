...
<footer>
	<div class="container">
		<div class="row footer_section_pre">
			...
			<div class="span4">
				<h4>
					Reservation Hotel<span class="line"></span>
				</h4>

				<p>ESPRIM Monastir</p>
				<p>
					Tel: +216-52-041-573<br />tel: +216-42-417-555 <br />Email:
					hamanlakhel@live.fr <br />Email: ghedirafakhreddine@gmail.com
				</p>
				...
				<ul data-facebook-action="recommend" data-url="#"
					...
					<li class="facebook"><a title="Share on Facebook"
						href="https://www.facebook.com/sharer/sharer.php?u=#"><span
							class="social-icon icon-facebook"></span><span class="count"></span></a></li>
				...
				<br />
				<p class="copy">
					All content &copy; 2013 <a href="http://appsarea.com/">AppsArea</a>
				</p>
			...
			<div class="span4">
				...
				<ul class="thumbnails">
					<li class="span2">
						<div class="thumbnail">
							<img
								src="<%=request.getContextPath()%>/resources/css/images/airlines/virgin4.gif"
								alt="">
						</div>
					</li>
					<li class="span2">
						<div class="thumbnail">
							<img
								src="<%=request.getContextPath()%>/resources/css/images/airlines/ba.png"
								alt="">
						</div>
					</li>
					<li class="span2">
						<div class="thumbnail">
							<img
								src="<%=request.getContextPath()%>/resources/css/images/airlines/delta3.gif"
								alt="">
						</div>
					</li>
					<li class="span2">
						<div class="thumbnail">
							<img
								src="<%=request.getContextPath()%>/resources/css/images/airlines/ac_white.jpg"
								alt="">
						</div>
					</li>
